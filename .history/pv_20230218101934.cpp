...
int main()
{
    ...
    //this section is used to calculate future value
        cout<<"Enter the Present Value(Pv)and hit Enter"<<endl;
        cin>>pv;
        cout<<"Enter interest rate(i) and hit enter"<<endl;
        cin>>i;
        cout<<"Enter period(time) and hit Enter" <<endl;
        cin>>n;
        fv = pv * (pow(((i/100)+1),n));
        cout<<"Future Value is "<<fv<<endl;
    break;
    case 'P':
        cout<<"Enter the Future Value(Fvn)and hit Enter"<<endl;
        cin>>fv;
