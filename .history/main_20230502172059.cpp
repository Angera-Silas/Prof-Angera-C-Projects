...
public:
    Student_info()
    {
        ...
        for (int i = 0; i < n; ++i)
        {
            ...
            //After entering the number of subjects you will be prompted to enter details of each and every 
            ...
            stud[i].name = stud->fname+" "+stud[i].mname+" "+stud[i].sname;
        }
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            cout << "|\tClASS"<<"\t"<< form << " " << stud->stream<<"\t\t\t\t|"<<endl;
            cout<<"|\tAGP"<<"\t"<<stud[i].agp<<"\t\t\t\t|"<<endl;
        }
    }
};
int main(int, char **)
