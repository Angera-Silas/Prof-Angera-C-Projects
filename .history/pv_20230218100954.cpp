...
int main()
{
    ...
    int m,o,q;
    char v;
    cout<<" WHAT DO YOU WANT TO CALCULATE?\n For future value type F and enter to proceed \n For Present value type P and enter to "<<endl;
    cout<<" For getting interest rate type in I and enter \n For Getting period(time)  type T and enter \n For Ordinary annuity press O and enter"<<endl;
    cout<<" For Present Value of Ordinary Annity type A and Enter \n For Annity due type D and Enter to proceed"
    cin>>v;
    switch (v)
    {
    case 'F':
